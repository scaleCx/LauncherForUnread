...
public class Launcher extends Activity
    ...
    public boolean mUnreadLoadCompleted = false; //op09 private
    private boolean mBindingWorkspaceFinished = false;
    public boolean mBindingAppsFinished = false;  //op09 private
    /// @}
    ...
    private boolean iscustomfor1701A = SystemProperties.getBoolean("ro.config.customize", false);
    @Override
    protected void onResume() {
        ...
        if (mOnResumeState == State.WORKSPACE) {
            ...
            if (iscustomfor1701A) {
                //change animated to true from false
                mWorkspace.setAlpha(0f); //mtk add
    ...
    boolean showWorkspace(int snapToPage, boolean animated, Runnable onCompleteRunnable) {
        ...
        if (changed) {
            ...
            if(iscustomfor1701A && !animated) {
                if (mPageIndicators != null) mPageIndicators.setAlpha(1f);  //add by mtk
                if (mWorkspace != null) mWorkspace.setAlpha(1f);  //add by mtk
            }
    ...
    public View getOrCreateQsbBar() {
        if (SystemProperties.getBoolean("ro.config.customize",false)) {
            return null;
        }else {
