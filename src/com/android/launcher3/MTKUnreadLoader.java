...
public class MTKUnreadLoader extends BroadcastReceiver {
    ...
    private static final String ACTION_SHOW_MISSED_CALLS_NOTIFICATION =
    ...
    static synchronized boolean setUnreadNumberAt(int index, int unreadNum) {
    	LauncherLog.d(TAG,"===setUnreadNumberAt:" +"   DEBUG_UNREAD: "+ LauncherLog.DEBUG_UNREAD);
        if (index >= 0 || index < sUnreadSupportShortcutsNum) {
            ...
            LauncherLog.d(TAG,"====:"+UNREAD_SUPPORT_SHORTCUTS.get(index).mUnreadNum+"   :"+unreadNum);
